...
class _ProfissionalScreenState extends State<ProfissionalScreen> {
  ModeloPrestadorServicos? prestadorModel;
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  title: Text(prestadorModel!.nome.toString()),
                  subtitle: Text(
                      '${prestadorModel!.idEndereco!.cidade} - ${prestadorModel!.idEndereco!.bairro}'),
                ),
                const Spacer(),
                ElevatedButton.icon(
                  onPressed: () {
                    FlutterOpenWhatsapp.sendSingleMessage(
                        '${prestadorModel!.idContato!.celular}',
                        'Mensagem do Flutter');
                  },
